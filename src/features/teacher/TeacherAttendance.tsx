...
export function TeacherAttendance() {
  ...
  const markAllRosterPresent = useOrbitStore((s) => s.markAllRosterPresent)
    ...
    <Panel
      ...
      action={
        <div className="flex flex-wrap gap-2 justify-end">
          <button
            type="button"
            onClick={markAllRosterPresent}
            className="btn-ghost flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold text-white border border-emerald-500/30"
          >
